...
INSERT INTO `ci_admin` VALUES (1, 'admin', 'd451119cf9093ecaa9a2b1190b7b2421', 1, '小张', '13586854083', NULL, 0, '', NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `ci_log` VALUES (1, NULL, '120.36.87.246', NULL, '登陆成功 用户名：admin', 1, NULL, '2016-01-03 15:31:22', '', '2016-01-03');
...
CREATE TABLE `ci_menu` (
  ...
  KEY `id` (`id`),
  KEY `parentId` (`parentId`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=203 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=203 ;
